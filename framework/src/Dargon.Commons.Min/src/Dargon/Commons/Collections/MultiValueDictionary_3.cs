...
namespace Dargon.Commons.Collections {
   ...
   public class MultiValueDictionary<TKey, TValue, TCollection> :
      ...
      ** Constructors
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}" /> 
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}" /> class that is 
      /// empty, has the specified initial capacity, and uses the default <see cref="IEqualityComparer{TKey}"/>
      /// for <typeparamref name="TKey"/>.
      /// </summary>
      /// <param name="capacity">Initial number of keys that the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}" /> will allocate space for</param>
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}" /> class 
      ...
      /// <summary>
      /// Initializes a new instance of the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}" /> class that contains 
      ...
      ** Static Factories
      ...
      /// <summary>
      /// Creates a new new instance of the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}" /> 
      /// class that is empty, has the default initial capacity, and uses the default
      ...
      /// The collection type that this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}" />
      /// will contain in its internal dictionary.
      /// </typeparam>
      /// <returns>A new <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}" /> with the specified
      /// parameters.</returns>
      ...
      ** Static Factories with Func parameters
      ...
      /// in the internal dictionary store of this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}" />.</param>
      /// <returns>A new <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}" /> with the specified
      /// parameters.</returns>
      ...
      ** Concrete Methods
      ...
      /// <summary>
      /// Adds the specified <typeparamref name="TKey"/> and <typeparamref name="TValue"/> to the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>.
      /// </summary>
      ...
      /// <remarks>
      /// Unlike the Add for <see cref="IDictionary" />, the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/> Add will not
      /// throw any exceptions. If the given <typeparamref name="TKey"/> is already in the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>,
      ...
      /// of whether the Add method actually modified the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}" />.
      /// </remarks>
      ...
      /// <summary>
      /// Adds a number of key-value pairs to this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>, where
      ...
      /// of whether the AddRange method actually modified the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>.
      /// </remarks>
      ...
      /// from the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>.
      /// </summary>
      ...
      /// pair from this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>. 
      /// </summary>
      ...
      /// <typeparamref name="TKey"/> will be removed from the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/> and its 
      ...
      /// pair exists within this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>.
      /// </summary>
      ...
      /// <summary>
      /// Determines if the given <typeparamref name="TValue"/> exists within this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>.
      /// </summary>
      /// <param name="value">A <typeparamref name="TValue"/> to search the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/> for</param>
      /// <returns><c>true</c> if the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/> contains the <paramref name="value"/>; otherwise <c>false</c></returns>      
      ...
      /// <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>.
      /// </summary>
      public void Clear() {
         dictionary.Clear();
         version++;
      ...
      ** Members implemented from IReadOnlyDictionary<TKey, IReadOnlyCollection<TValue>>
      ...
      /// <summary>
      /// Determines if the given <typeparamref name="TKey"/> exists within this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/> and has
      /// at least one <typeparamref name="TValue"/> associated with it.
      /// </summary>
      /// <param name="key">The <typeparamref name="TKey"/> to search the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/> for</param>
      /// <returns><c>true</c> if the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/> contains the requested <typeparamref name="TKey"/>;
      ...
      /// <summary>
      /// Gets each <typeparamref name="TKey"/> in this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/> that
      /// has one or more associated <typeparamref name="TValue"/>.
      /// </summary>
      /// <value>
      /// An <see cref="IEnumerable{TKey}"/> containing each <typeparamref name="TKey"/> 
      /// in this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/> that has one or more associated 
      ...
      /// </param>
      /// <returns>
      /// <c>true</c> if the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/> contains an element with the specified 
      ...
      /// <summary>
      /// Gets an enumerable of <see cref="IReadOnlyCollection{TValue}"/> from this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>,
      /// where each <see cref="IReadOnlyCollection{TValue}" /> is the collection of every <typeparamref name="TValue"/> associated
      /// with a <typeparamref name="TKey"/> present in the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>. 
      /// </summary>
      /// <value>An IEnumerable of each <see cref="IReadOnlyCollection{TValue}"/> in this 
      /// <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/></value>
      ...
      /// <paramref name="key"/> is not found in this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>, will 
      ...
      /// <typeparamref name="TValue"/>s in this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>.</exception>
      /// <value>
      ...
      /// to the <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/> 
      /// </remarks>
      ...
      /// in this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>.
      /// </summary>
      /// <value>The number of <typeparamref name="TKey"/>s in this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>.</value>
      public int Count
      {
         get
         {
      ...
      /// pairs in this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>.
      /// </summary>
      /// <returns>an Enumerator over the <typeparamref name="TKey"/>-<see cref="IReadOnlyCollection{TValue}"/>
      /// pairs in this <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>.</returns>
      ...
      /// <summary>
      /// The Enumerator class for a <see cref="Dargon.Commons.Collections.MultiValueDictionary{TKey,TValue}"/>
