...
writer.WriteRawString(self.s);
                                                                                                                              ...
                                                                                                                              void IVoxSerializer.WriteFullObject(VoxWriter writer, object val) { SimpleTestType v = (SimpleTestType)val; WriteFull(writer, ref v); }
...
for (var _voxvarname_dict_i = 0; _voxvarname_dict_i < _voxvarname_dict_count; _voxvarname_dict_i++) {
   ...
   _voxvarname_dict.Add(_voxvarname_dict_key, _voxvarname_dict_val);
                                                                                                                              ...
                                                                                                                              void IVoxSerializer.WriteFullObject(VoxWriter writer, object val) { HodgepodgeMin v = (HodgepodgeMin)val; WriteFull(writer, ref v); }
                                                                                                                              object IVoxSerializer.ReadRawAsObject(VoxReader reader) => ReadRaw(reader);
                                                                                                                           }
                                                                                                                        ...
                                                                                                                        namespace System {
                                                                                                                           ...
                                                                                                                           public sealed partial class Int32Serializer : IVoxSerializer<Int32> {
                                                                                                                              ...
                                                                                                                              void IVoxSerializer.WriteFullObject(VoxWriter writer, object val) { Int32 v = (Int32)val; WriteFull(writer, ref v); }
                                                                                                                              object IVoxSerializer.ReadRawAsObject(VoxReader reader) => ReadRaw(reader);
                                                                                                                           }
...
public static partial Int32 Stub_ReadRaw_Int32(VoxReader reader);
                                                                                                                        ...
                                                                                                                        namespace System {
                                                                                                                           ...
                                                                                                                           public sealed partial class StringSerializer : IVoxSerializer<String> {
                                                                                                                              ...
                                                                                                                              void IVoxSerializer.WriteFullObject(VoxWriter writer, object val) { String v = (String)val; WriteFull(writer, ref v); }
                                                                                                                              object IVoxSerializer.ReadRawAsObject(VoxReader reader) => ReadRaw(reader);
                                                                                                                           }
...
public static partial String Stub_ReadRaw_String(VoxReader reader);
                                                                                                                        ...
                                                                                                                        namespace System {
                                                                                                                           ...
                                                                                                                           public sealed partial class GuidSerializer : IVoxSerializer<Guid> {
                                                                                                                              ...
                                                                                                                              void IVoxSerializer.WriteFullObject(VoxWriter writer, object val) { Guid v = (Guid)val; WriteFull(writer, ref v); }
                                                                                                                              object IVoxSerializer.ReadRawAsObject(VoxReader reader) => ReadRaw(reader);
                                                                                                                           }
