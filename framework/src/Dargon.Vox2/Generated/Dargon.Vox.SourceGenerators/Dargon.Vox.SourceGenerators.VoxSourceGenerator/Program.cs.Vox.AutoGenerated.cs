                                                                                                                        ...
                                                                                                                        namespace Dargon.Vox2 {
                                                                                                                           ...
                                                                                                                           public sealed partial class SimpleTestTypeSerializer : IVoxSerializer<SimpleTestType> {
                                                                                                                              ...
                                                                                                                              public int[] FullTypeId { get; } = new[] { -2147483647 };
                                                                                                                              public byte[] FullTypeIdBytes { get; } = (-2147483647).ToVariableIntBytes();

                                                                                                                              public bool IsUpdatable => true;

                                                                                                                              public void WriteTypeIdBytes(VoxWriter writer) => writer.WriteTypeIdBytes(SimpleTestTypeVoxConstants.TypeIdBytes);
                                                                                                                              public void AssertReadTypeId(VoxReader reader) => reader.AssertReadTypeIdBytes(SimpleTestTypeVoxConstants.TypeIdBytes);
                                                                                                                        ...
                                                                                                                        namespace Dargon.Vox2 {
                                                                                                                           ...
                                                                                                                           public static class HodgepodgeMinVoxConstants {
                                                                                                                              public const int TypeId = -2147483646;
                                                                                                                           ...
                                                                                                                           public sealed partial class HodgepodgeMinSerializer : IVoxSerializer<HodgepodgeMin> {
                                                                                                                              ...
                                                                                                                              public int[] FullTypeId { get; } = new[] { -2147483646 };
                                                                                                                              public byte[] FullTypeIdBytes { get; } = (-2147483646).ToVariableIntBytes();

                                                                                                                              public bool IsUpdatable => true;

                                                                                                                              public void WriteTypeIdBytes(VoxWriter writer) => writer.WriteTypeIdBytes(HodgepodgeMinVoxConstants.TypeIdBytes);
                                                                                                                              public void AssertReadTypeId(VoxReader reader) => reader.AssertReadTypeIdBytes(HodgepodgeMinVoxConstants.TypeIdBytes);
...
var _arr = _arr_count == -1 ? null : new int[_arr_count];
for (var _arr_i = 0; _arr_i < _arr_count; _arr_i++) {
   _arr[_arr_i] = reader.ReadRawInt32();
}
                                                                                                                                  ...
                                                                                                                                  {
var _dict_count = reader.ReadRawInt32();
var _dict = new System.Collections.Generic.Dictionary<int, System.Collections.Generic.Dictionary<object, int[]>[][]>(_dict_count);
for (var _dict_i = 0; _dict_i < _dict_count; _dict_i++) {
   var _dict_key = reader.ReadRawInt32();
   var _dict_val_arr_count = reader.ReadRawInt32();
   var _dict_val_arr = _dict_val_arr_count == -1 ? null : new System.Collections.Generic.Dictionary<object, int[]>[_dict_val_arr_count][];
   for (var _dict_val_arr_i = 0; _dict_val_arr_i < _dict_val_arr_count; _dict_val_arr_i++) {
      var _dict_val_arr_el_arr_count = reader.ReadRawInt32();
      var _dict_val_arr_el_arr = _dict_val_arr_el_arr_count == -1 ? null : new System.Collections.Generic.Dictionary<object, int[]>[_dict_val_arr_el_arr_count];
      for (var _dict_val_arr_el_arr_i = 0; _dict_val_arr_el_arr_i < _dict_val_arr_el_arr_count; _dict_val_arr_el_arr_i++) {
         var _dict_val_arr_el_arr_el_dict_count = reader.ReadRawInt32();
         var _dict_val_arr_el_arr_el_dict = new System.Collections.Generic.Dictionary<object, int[]>(_dict_val_arr_el_arr_el_dict_count);
         for (var _dict_val_arr_el_arr_el_dict_i = 0; _dict_val_arr_el_arr_el_dict_i < _dict_val_arr_el_arr_el_dict_count; _dict_val_arr_el_arr_el_dict_i++) {
            var _dict_val_arr_el_arr_el_dict_key = reader.ReadPolymorphic<Object>();
            var _dict_val_arr_el_arr_el_dict_val_arr_count = reader.ReadRawInt32();
            var _dict_val_arr_el_arr_el_dict_val_arr = _dict_val_arr_el_arr_el_dict_val_arr_count == -1 ? null : new int[_dict_val_arr_el_arr_el_dict_val_arr_count];
            for (var _dict_val_arr_el_arr_el_dict_val_arr_i = 0; _dict_val_arr_el_arr_el_dict_val_arr_i < _dict_val_arr_el_arr_el_dict_val_arr_count; _dict_val_arr_el_arr_el_dict_val_arr_i++) {
               _dict_val_arr_el_arr_el_dict_val_arr[_dict_val_arr_el_arr_el_dict_val_arr_i] = reader.ReadRawInt32();
            }
            var _dict_val_arr_el_arr_el_dict_val = _dict_val_arr_el_arr_el_dict_val_arr;
            _dict_val_arr_el_arr_el_dict.Add(_dict_val_arr_el_arr_el_dict_key, _dict_val_arr_el_arr_el_dict_val);
         }
         _dict_val_arr_el_arr[_dict_val_arr_el_arr_i] = _dict_val_arr_el_arr_el_dict;
      }
      _dict_val_arr[_dict_val_arr_i] = _dict_val_arr_el_arr;
   }
   var _dict_val = _dict_val_arr;
   _dict.Add(_dict_key, _dict_val);
}

                                                                                                                                     self.DictOfIntToArrayOfArrayOfDictOfStringToIntArray = _dict;
                                                                                                                                  }
 }
                                                                                                                           ...
                                                                                                                           public partial class HodgepodgeMin : IVoxCustomType<HodgepodgeMin> {
                                                                                                                              public int TypeId => HodgepodgeMinVoxConstants.TypeId;
                                                                                                                        ...
                                                                                                                        namespace System {
                                                                                                                           ...
                                                                                                                           public sealed partial class Int32Serializer : IVoxSerializer<Int32> {
                                                                                                                              ...
                                                                                                                              public int[] FullTypeId { get; } = new[] { -21 };
                                                                                                                              public byte[] FullTypeIdBytes { get; } = (-21).ToVariableIntBytes();
                                                                                                                              ...
                                                                                                                              public void AssertReadTypeId(VoxReader reader) => reader.AssertReadTypeIdBytes(Int32VoxConstants.TypeIdBytes);
...
public static partial Int32 Stub_ReadRaw_Int32(VoxReader reader);
                                                                                                                        ...
                                                                                                                        namespace System {
                                                                                                                           ...
                                                                                                                           public sealed partial class StringSerializer : IVoxSerializer<String> {
                                                                                                                              ...
                                                                                                                              public int[] FullTypeId { get; } = new[] { -32 };
                                                                                                                              public byte[] FullTypeIdBytes { get; } = (-32).ToVariableIntBytes();

                                                                                                                              public bool IsUpdatable => false;

                                                                                                                              public void WriteTypeIdBytes(VoxWriter writer) => writer.WriteTypeIdBytes(StringVoxConstants.TypeIdBytes);
                                                                                                                              public void AssertReadTypeId(VoxReader reader) => reader.AssertReadTypeIdBytes(StringVoxConstants.TypeIdBytes);
...
public static partial String Stub_ReadRaw_String(VoxReader reader);
                                                                                                                        ...
                                                                                                                        namespace System {
                                                                                                                           ...
                                                                                                                           public sealed partial class GuidSerializer : IVoxSerializer<Guid> {
                                                                                                                              ...
                                                                                                                              public int[] FullTypeId { get; } = new[] { -29 };
                                                                                                                              public byte[] FullTypeIdBytes { get; } = (-29).ToVariableIntBytes();

                                                                                                                              public bool IsUpdatable => false;

                                                                                                                              public void WriteTypeIdBytes(VoxWriter writer) => writer.WriteTypeIdBytes(GuidVoxConstants.TypeIdBytes);
                                                                                                                              public void AssertReadTypeId(VoxReader reader) => reader.AssertReadTypeIdBytes(GuidVoxConstants.TypeIdBytes);
