...
for (var _voxvarname_arr_i = 0; _voxvarname_arr_i < _voxvarname_arr_count; _voxvarname_arr_i++) {
   _voxvarname_arr[_voxvarname_arr_i] = reader.ReadPolymorphic<object>();
                                                                                                                           ...
                                                                                                                           public partial class RmiRequestDto /* : IVoxCustomType<Dargon.Courier.ServiceTier.Vox.RmiRequestDto> */ {
                                                                                                                              private static RmiRequestDtoSerializer GetSerializerInstance(VoxContext vox) => RmiRequestDtoSerializer.GetInstance(vox.SerializerContainer);
                                                                                                                              // public RmiRequestDtoSerializer Serializer => RmiRequestDtoSerializer.Instance;
                                                                                                                              // IVoxSerializer IVoxCustomType.Serializer => Serializer;
                                                                                                                              // IVoxSerializer<Dargon.Courier.ServiceTier.Vox.RmiRequestDto> IVoxCustomType<Dargon.Courier.ServiceTier.Vox.RmiRequestDto>.Serializer => Serializer;
                                                                                                                           ...
                                                                                                                           public static class VoxGenerated_RmiRequestDtoStatics {
                                                                                                                              public static void WriteFullRmiRequestDto(this VoxWriter writer, Dargon.Courier.ServiceTier.Vox.RmiRequestDto value) { var copy = value; RmiRequestDtoSerializer.GetInstance(writer.Context).WriteFull(writer, ref value); }
                                                                                                                              public static void WriteRawRmiRequestDto(this VoxWriter writer, Dargon.Courier.ServiceTier.Vox.RmiRequestDto value) { var copy = value; RmiRequestDtoSerializer.GetInstance(writer.Context).WriteRaw(writer, ref value); }
                                                                                                                              public static RmiRequestDto ReadFullRmiRequestDto(this VoxReader reader) => RmiRequestDtoSerializer.GetInstance(reader.Context).ReadFull(reader);
                                                                                                                              public static RmiRequestDto ReadRawRmiRequestDto(this VoxReader reader) => RmiRequestDtoSerializer.GetInstance(reader.Context).ReadRaw(reader);
                                                                                                                           }
                                                                                                                        }
...
for (var _voxvarname_arr_i = 0; _voxvarname_arr_i < _voxvarname_arr_count; _voxvarname_arr_i++) {
   _voxvarname_arr[_voxvarname_arr_i] = reader.ReadPolymorphic<object>();
                                                                                                                           ...
                                                                                                                           public partial class RmiResponseDto /* : IVoxCustomType<Dargon.Courier.ServiceTier.Vox.RmiResponseDto> */ {
                                                                                                                              private static RmiResponseDtoSerializer GetSerializerInstance(VoxContext vox) => RmiResponseDtoSerializer.GetInstance(vox.SerializerContainer);
                                                                                                                              // public RmiResponseDtoSerializer Serializer => RmiResponseDtoSerializer.Instance;
                                                                                                                              // IVoxSerializer IVoxCustomType.Serializer => Serializer;
                                                                                                                              // IVoxSerializer<Dargon.Courier.ServiceTier.Vox.RmiResponseDto> IVoxCustomType<Dargon.Courier.ServiceTier.Vox.RmiResponseDto>.Serializer => Serializer;
                                                                                                                           ...
                                                                                                                           public static class VoxGenerated_RmiResponseDtoStatics {
                                                                                                                              public static void WriteFullRmiResponseDto(this VoxWriter writer, Dargon.Courier.ServiceTier.Vox.RmiResponseDto value) { var copy = value; RmiResponseDtoSerializer.GetInstance(writer.Context).WriteFull(writer, ref value); }
                                                                                                                              public static void WriteRawRmiResponseDto(this VoxWriter writer, Dargon.Courier.ServiceTier.Vox.RmiResponseDto value) { var copy = value; RmiResponseDtoSerializer.GetInstance(writer.Context).WriteRaw(writer, ref value); }
                                                                                                                              public static RmiResponseDto ReadFullRmiResponseDto(this VoxReader reader) => RmiResponseDtoSerializer.GetInstance(reader.Context).ReadFull(reader);
                                                                                                                              public static RmiResponseDto ReadRawRmiResponseDto(this VoxReader reader) => RmiResponseDtoSerializer.GetInstance(reader.Context).ReadRaw(reader);
                                                                                                                           }
                                                                                                                        }
