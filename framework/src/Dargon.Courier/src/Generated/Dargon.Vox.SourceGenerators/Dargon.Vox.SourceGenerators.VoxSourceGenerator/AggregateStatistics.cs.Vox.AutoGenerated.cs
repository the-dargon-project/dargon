...
_dep_T.WriteRaw(writer, ref _voxvarname_copy);
                                                                                                                           ...
                                                                                                                           public partial class AggregateStatistics<T> /* : IVoxCustomType<Dargon.Courier.AuditingTier.AggregateStatistics<T>> */ {
                                                                                                                              private static AggregateStatisticsSerializer<T> GetSerializerInstance(VoxContext vox) => AggregateStatisticsSerializer<T>.GetInstance(vox.SerializerContainer);
                                                                                                                              // public AggregateStatisticsSerializer<T> Serializer => AggregateStatisticsSerializer<T>.Instance;
                                                                                                                              // IVoxSerializer IVoxCustomType.Serializer => Serializer;
                                                                                                                              // IVoxSerializer<Dargon.Courier.AuditingTier.AggregateStatistics<T>> IVoxCustomType<Dargon.Courier.AuditingTier.AggregateStatistics<T>>.Serializer => Serializer;
                                                                                                                           ...
                                                                                                                           public static class VoxGenerated_AggregateStatisticsStatics {
                                                                                                                              public static void WriteFullAggregateStatistics<T>(this VoxWriter writer, Dargon.Courier.AuditingTier.AggregateStatistics<T> value) { var copy = value; AggregateStatisticsSerializer<T>.GetInstance(writer.Context).WriteFull(writer, ref value); }
                                                                                                                              public static void WriteRawAggregateStatistics<T>(this VoxWriter writer, Dargon.Courier.AuditingTier.AggregateStatistics<T> value) { var copy = value; AggregateStatisticsSerializer<T>.GetInstance(writer.Context).WriteRaw(writer, ref value); }
                                                                                                                              public static AggregateStatistics<T> ReadFullAggregateStatistics<T>(this VoxReader reader) => AggregateStatisticsSerializer<T>.GetInstance(reader.Context).ReadFull(reader);
                                                                                                                              public static AggregateStatistics<T> ReadRawAggregateStatistics<T>(this VoxReader reader) => AggregateStatisticsSerializer<T>.GetInstance(reader.Context).ReadRaw(reader);
                                                                                                                           }
                                                                                                                        }
